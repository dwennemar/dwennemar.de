...
export default function LegalNotice() {
  return (
    <div className="impressum">
      ...
      <Text h3 style={{margin: 1}}>Haftung f&uuml;r Inhalte</Text>
      <Text style={{margin: 1}}>
      ...
      <Text h3 style={{margin: 1}}>Haftung f&uuml;r Links</Text>
      <Text style={{margin: 1}}>
      ...
      <Text h3 style={{margin: 1}}>Urheberrecht</Text>
      <Text style={{margin: 1}}>
